...
public class ClienteServiceImp implements ClienteServInterface {
    ...
    public Cliente decryptCliente (Cliente cliente) {
        ...
        try {
            cliente.setNombre(encryptServ.decrypt(cliente.getPersona().getNombre()));
            cliente.setTelefono(encryptServ.decrypt(cliente.getPersona().getTelefono()));
            cliente.setDireccion(encryptServ.decrypt(cliente.getPersona().getDireccion()));
