...
public class movimientoService implements MovimientosServInterface {
    ...
    @Override
    public MovimientosDTO updateMovimiento(Movimientos movimiento, String idMovimiento) {
        ...
        try {
            ...
            if(verificaMovimiento.isPresent()){
                ...
                movimientoResultado = MovimientosDTO.build(clientebd, cuentabd, movimientoagregado);
            }
