...
public class ClienteServiceImp implements ClienteServInterface {
    ...
    public Cliente  encryptCliente (Cliente cliente){
        ...
        try {
            cliente.setNombre(encryptServ.encrypt(cliente.getNombre()));
            cliente.setTelefono(encryptServ.encrypt(cliente.getTelefono()));
            cliente.setDireccion(encryptServ.encrypt(cliente.getDireccion()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public Cliente decryptCliente (Cliente cliente) {
        ...
        try {
            cliente.setNombre(encryptServ.decrypt(cliente.getNombre()));
            cliente.setTelefono(encryptServ.decrypt(cliente.getTelefono()));
            cliente.setDireccion(encryptServ.decrypt(cliente.getDireccion()));
