    ...
    public Optional<MovimientosDTO> updateMovimiento(Movimientos movimiento, String idMovimiento) {
        try {
            ...
            if(verificaMovimiento.isPresent()){
                ...
                movimientobd.setMovimiento(movimiento.getMovimiento());

                Long saldoMovimiento = Long.valueOf(String.valueOf(cuentabd.getSaldo())) + Long.valueOf(movimiento.getMovimiento());
                movimientobd.setSaldo(String.valueOf(saldoMovimiento));
                movimientobd.setValor(idMovimiento);
            }
