...
public class ClienteServiceImp implements ClienteServInterface {
    ...
    public Cliente  encryptCliente (Cliente cliente){
        ...
        try {
            ...
            clienteenc.setPersona(clienteenc);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public Cliente decryptCliente (Cliente cliente) {
        ...
        try {
            ...
            persona.setNombre(encryptServ.decrypt(cliente.getNombre()));
            persona.setTelefono(encryptServ.decrypt(cliente.getTelefono()));
            persona.setDireccion(encryptServ.decrypt(cliente.getDireccion()));
