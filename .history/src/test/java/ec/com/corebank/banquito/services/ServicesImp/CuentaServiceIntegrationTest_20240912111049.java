...
public class CuentaServiceIntegrationTest {
    ...
    public void setUp() {
        ...
        cliente = new Cliente("cliente123", "securePassword", true);
        cliente.setNombre("Hades Polydegmon");
        cliente.setGenero("Masculino");
        cliente.setEdad(30);
        cliente.setIdentificacion("1234567890");
        cliente.setDireccion("Campos eliseos");
        cliente.setTelefono("535-1234");
    ...
    public void testSaveAndFindCuenta() {
        ...
        CuentaDTO cuentaDTO = new CuentaDTO("100100", cliente.getClienteid(), "AHORRO", "1000", true);
